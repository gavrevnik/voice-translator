...
- Перевод: **Gemini Flash-Lite** по умолчанию с выбором `gemini-3.1-flash-lite` или `gemini-3.5-flash-lite`; обе используют thinking `minimal`. Альтернатива — **OpenAI API** с `gpt-5.6-luna` и фиксированным reasoning `none`.
